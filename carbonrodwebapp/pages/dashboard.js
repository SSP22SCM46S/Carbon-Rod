...
const dashboard = () => {
  const data ={
    ...
    datasets: [{
      data: [100, 333, 232,123, 456,433,565,343,134,534],
      backgroundColor:'transparent',
      borderColor: '#64c297',
      pointBorderColor: '#64c297',
      pointborderWidth:4,
      fill: true,
  ...
  return (
    <div>
         <div class="  flex overflow-hidden bg-[#f9fafb] pt-16 ">
      <aside id="sidebar" class="    bg-[#64c297] fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
         <div class="   bg-[#64c297] relative flex-1 flex flex-col min-h-0 border-r border-white  pt-0">
            <div class=" bg-[#64c297]flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div class=" flex-1 px-3 bg-[#64c297] divide-y space-y-1 ">
                  <ul class=" space-y-2 pb-2">
                     ...
                     <li>
                        <a href="#" class="text-base text-[#e9ecef] font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                           <svg class="w-6 h-6 text-[#e9ecef] group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           <svg class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                              <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                           </svg>
                           <Link href = "/devicereadings">
                           <span class="ml-3 flex-1 whitespace-nowrap">Device Readings</span>
                     ...
                     <li>
                        <a href="#" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                        <svg class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                           <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                           <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
                        </svg>
                           <span class="ml-3 flex-1 whitespace-nowrap">Past Readings </span>
                        </a>
                     </li>
                  ...
                  <div class="space-y-2 pt-2">
                     ...
                     <a href="#" target="_blank" class="text-base text-[#e9ecef] font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                     <svg class="w-6 h-6 text-[#e9ecef] flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="pt-6 px-4">
                  ...
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                     <div class="flex items-center justify-between mb-4">
                        <div class="flex-shrink-0">
                           ...
                           <h3 class="text-base font-normal text-gray-500">Total Tree Cost</h3>
                        </div>
               ...
               <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                     <div class="flex items-center">
                        <div class="flex-shrink-0">
                           ...
                           <h3 class="text-base font-normal text-gray-500">Trees Planted</h3>
                        </div>
                  ...
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                     <div class="flex items-center">
                        <div class="flex-shrink-0">
                           <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">420.99 ppm</span>
                           <h3 class="text-base font-normal text-gray-500">Average CO2 Levels</h3>
                        </div>
                  ...
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                     <div class="flex items-center">
                        <div class="flex-shrink-0">
                           <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">1.6 tons</span>
                           <h3 class="text-base font-normal text-gray-500">Total CO2 Emissions Captured Per Year</h3>
                        </div>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-orange-300 h-2 rounded-sm w-30"></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-teal-400 h-2 rounded-sm w-10" ></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-pink-600 h-2 rounded-sm w-10" ></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 px-4 align-middle text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-indigo-600 h-2 rounded-sm w-10" ></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
                              ...
                              <tr class="text-gray-500">
                                 ...
                                 <td class="border-t-0 align-middle text-xs whitespace-nowrap p-4 pb-0">
                                    <div class="flex items-center">
                                       ...
                                       <div class="relative w-full">
                                          <div class="w-full bg-gray-200 rounded-sm h-2">
                                             <div class="bg-purple-500 h-2 rounded-sm w-5" ></div>
                                          </div>
                                       </div>
                                    </div>
                                 </td>
...
<div className="bg-white shadow rounded-lg p-4 m-10 sm:p-6 xl:p-8">
<h1 className="text-center">CO2 Level Timeline</h1>
<Line data= {data} options={options} />
         ...
         <p class="text-center text-sm text-gray-500 my-10">
            &copy; 2022 <a href="#" class="hover:underline" target="_blank">Tree of Life</a>. All rights reserved.
         </p>
      </div>
   </div>
    </div>
